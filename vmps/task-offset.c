...
static int get_ops(unsigned int *ops, unsigned int addrsize, Dwarf_Word len, 
...
static int process_debug_info(Dwfl_Module *dwflmod,
            ...
            GElf_Shdr *shdr, Dwarf *dbg, Dwarf_Request *req)
{
	int ret = EX_OK;
...
static int process_debug(Dwfl_Module *dwflmod, Ebl *ebl, GElf_Ehdr *ehdr, 
	Dwarf_Request *req)
{
	Dwarf_Addr dwbias;
...
static int find_sched(Dwarf_Off *sched_from, Dwarf_Off *sched_to, 
	const char *fname)
{
	int fd, ret;
	Dwarf_Request req;
...
static int find_task_struct(Dwarf_Off *task_from, Dwarf_Off *task_to,
	const Dwarf_Off sched_from, const Dwarf_Off sched_to, const char *fname)
{
	int fd, ret;
	Dwarf_Request req;
...
static int find_task_member(unsigned int *offset, char *name, 
	const Dwarf_Off task_from, const Dwarf_Off task_to, const char *fname)
{
	int fd, ret;
	Dwarf_Request req;
