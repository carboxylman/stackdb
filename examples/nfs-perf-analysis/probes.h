...
typedef enum nfs_perf_stage_id {
	...
	STAGE_ID_TCP_DATA_QUEUE          = 6,
        ...
        STAGE_ID_SVC_RECVFROM            = 8,
        STAGE_ID_NFSD3_PROC_WRITE        = 9,
        STAGE_ID_DO_READV_WRITEV         = 10, 
        STAGE_ID_GENERIC_FILE_WRITEV     = 11, 
        STAGE_ID_GENERIC_FILE_BUFFERED_WRITE = 12, 
        STAGE_ID_EXT3_JOURNALLED_WRITEPAGE = 13, 
        STAGE_ID___BLOCK_WRITE_FULL_PAGE = 14, 
        STAGE_ID_SUBMIT_BH               = 15, 
        STAGE_ID_BLKIF_QUEUE_REQUEST     = 16,
        STAGE_ID_BLKIF_INT               = 17,	
