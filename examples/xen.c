...
/**
 ** This is a simple program that probes Xen VMs via the Xen driver.
 ** Skip on down to main() so you get an idea of what's going on; then
 ** read through the rest as necessary.
 **/
...
int main(int argc,char **argv) {
    ...
    vmi_set_log_area_flags(LA_TARGET,LF_T_ALL | LF_XV);
