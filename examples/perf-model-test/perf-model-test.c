...
/*
 *  examples/perf-model-test/perf-model-test.c
 *
...
const struct argp parser_def =
{
    ...
    .parser = cmd_parser,
    .doc =
        "Benchmarking and testing the XenTT performance model during repay"
};


const char *argp_program_version     = "perf-model-test v0.1";
